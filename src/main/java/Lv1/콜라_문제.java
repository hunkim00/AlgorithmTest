...
// 상빈이가 푼 방법은 아래 그//단, 보유 중인 빈 병이 2개 미만이면, 콜라를 받을 수 없다.
////문제를 풀던 상빈이는 콜라 문제의 완벽한 해답을 찾았습니다.림과 같습니다. 우선 콜라 빈 병 20병을 가져가서 10병을 받습니다.
...
public class 콜라_문제 {
    class soultion(int a, int b, int n){
        int answer = 0;
